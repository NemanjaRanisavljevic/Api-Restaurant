...
namespace WebApp
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            services.AddTransient<IGetAllImpressionWebCommand, EFGetAllImpressionWebCommand>();
            services.AddTransient<IGetImpressionWebCommand, EFGetImpressionWebCommand>();
